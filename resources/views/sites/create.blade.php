...
@section('breadcrumbs')
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/templates">Sites</a></li>
        <li class="breadcrumb-item"><a href="javascript:void(0)">New Site</a></li>
    </ol>
@stop
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="basic-form">
                    ...
                    <form method="post" action="/sites/save" autocomplete="off" data-parsley-validate>
                        ...
                        <h4 class="card-title">Site url</h4>
                        <div class="form-row" style="margin-bottom:15px;">
                            <div class="col-sm-4">
                                <input data-parsley-error-message="Template is required"  data-parsley-required name="site_url" id="site_url" class="form-control"></input>
                            </div>
                        </div>
                        ...
                        <div class="form-row" style="margin-bottom:15px;">
                            <div class="col-sm-4">
                                <input data-parsley-error-message="Template is required"  data-parsley-required name="script" id="script" class="form-control"></input>
                            </div>
                        </div>
